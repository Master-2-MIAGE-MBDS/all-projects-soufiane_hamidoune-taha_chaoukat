...
<head>
    ...
    <asset:stylesheet src="custom.css.css"/>
...
<div id="wrapper">
    <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
        ...
        float: right;
        font-size: 16px;"><a <g:link controller="logout" > Logout</a> </div>
    </nav>
    <!-- /. NAV TOP  -->
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a  href="ui.html"><i class="fa fa-desktop fa-3x"></i> Menu</a>
                </li>
                <li>
                    <a  href="tab-panel.html"><i class="fa fa-qrcode fa-3x"></i> déposer une annonce</a>
                </li>
                <li  >
                    <a   href="chart.html"><i class="fa fa-bar-chart-o fa-3x"></i> Evenements</a>
                </li>
                <li  >
                    <a  href="table.html"><i class="fa fa-table fa-3x"></i>Annonces</a>
                </li>
                <li  >
                    <a  href="form.html"><i class="fa fa-edit fa-3x"></i> Favoris </a>
                </li>
